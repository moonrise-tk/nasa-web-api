...
jQuery(document).ready(function () {
    ...
    searchStartDate = document.getElementById(
    ...
    window.onclick = function (event) {
        if (event.target == modal) {
            ...
            applySearch();
            clearSearchModal();
        } else if (event.target == document.getElementById("info-modal")) {
    ...
    $("#toggle-switch-ring").click(function () {
        if (
            document.getElementById("toggle-switch").getAttribute("selected") ==
            "false"
        ) {
            document
            ...
            $("#github-logo").attr(
                "src",
                "assets/images/GitHub-Logos/GitHub_Logo_White.png"
            );
        } else {
            document
                .getElementById("toggle-switch")
            ...
            $("#github-logo").attr(
                "src",
                "assets/images/GitHub-Logos/GitHub_Logo.png"
            );
        }
    });
...
function parseResponse(responseText) {
    ...
    document.getElementById("metadata").textContent =
        "Total hits: " + res.collection.metadata.total_hits;
...
function showFavorites() {
    ...
    if (favorites.length > 0) {
        document.getElementById("favorites-metadata").textContent =
...
function showData(element) {
    ...
    switch (media_type) {
        ...
        case "audio":
            var src =
                "https://images-assets.nasa.gov/audio/" +
                nasa_id +
                "/" +
                nasa_id +
                "~orig.wav";
...
function findSimilar() {
    ...
    var keywords = JSON.parse(
        sessionStorage.getItem(nasa_id)
    ).keywords.toString();
    var searchKeywords =
...
function alert() {
    document.getElementById("metadata").textContent =
        "Something went wrong trying to display this!";
}
